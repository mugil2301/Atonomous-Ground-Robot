...
def detect_markers(img, camera_matrix, dist_coeff):
	...
	corners, ids, _ = aruco.detectMarkers(gray, aruco_dist,parameters)
	aruco_dict = aruco.Dictionary_get(aruco.DICT_5X5_250)
	rvec,tvec= aruco.estimatePoseSingleMarkers(corners,markerLength,camera_matrix,dist_coeff)
	#aruco_list=[(corners),(ids),(rvec),(tvec)]
	return aruco_list
...
if __name__=="__main__":
	...
	img = cv2.imread("E:\\3D\\eYRTC\\task1#tc\\Task 1\\Task 1.1\\TestCases\\image_1.jpg")
